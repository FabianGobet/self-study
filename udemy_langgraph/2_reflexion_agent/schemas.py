...
class AnswerQuestion(BaseModel):
    ...
    search_queries: List[str] = Field(description="1-3 search queries to research information and improve your answer.")
    
class ReviseAnswer(AnswerQuestion):
    referances: List[str] = Field(description="citations motivating your updated answer.")
